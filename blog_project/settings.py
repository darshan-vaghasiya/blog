...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'users.jwt_authentication.CustomJWTAuthentication',
    ],
    'DEFAULT_PAGINATION_CLASS': 'blog_project.paginator.CustomPagination',
    'PAGE_SIZE': 10,
...
LOGGING = {
    ...
    'handlers': {
        ...
        'custom_logger': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': os.path.join(LOG_DIR, 'custom.log'),
        },
    },
    'loggers': {
        'django': {
